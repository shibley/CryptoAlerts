...
namespace CryptoAlerts
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            string result = wsh.Send("42[\"SubAdd\",{\"subs\":[\"2~Bitstamp~BTC~USD\",\"2~Coinbase~BTC~USD\"]}]");//,\"2~Poloniex~BTC~USD\",\"2~Bitfinex~BTC~USD\
            //Console.WriteLine(result);
            Console.ReadKey(true);

            //CryptoDataSource ds = new CryptoDataSource();
            ...
            //    ws.Connect();
            //    ws.Send("{ \"op\": \"subscribe\", \"args\": [\"quote\"]}");
            //    Console.ReadKey(true);
            //}
        }
    }
